      ...
      <div className="container contact_container">
        ...
        >
          <article className="contact_option">
            ...
            <a href="mailto:shivam.ssr4518@gmail.com" target="_blank">
              Send a message
            </a>
          </article>
          <article className="contact_option">
            ...
            <h4>WhatsApp</h4>
            <a
              href="https://api.whatsapp.com/send?phone=9219060343&text=Hi, Shivam I Want to hire you, you are interested to join our team "
              target="_blank"
            >
              Send a message
            </a>
